...
#include "sensor/msg/detail/device_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sensor::msg::DeviceStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sensor::msg::DeviceStatus & ros_message)
{
  // Member: temperature
  cdr >> ros_message.temperature;
...
{
  auto typed_message =
    static_cast<const sensor::msg::DeviceStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sensor::msg::DeviceStatus *>(
    untyped_ros_message);
...
{
  return max_serialized_size_DeviceStatus(full_bounded, 0);
}
...
{
  return &sensor::msg::typesupport_fastrtps_cpp::_DeviceStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sensor, msg, DeviceStatus)() {
  return &sensor::msg::typesupport_fastrtps_cpp::_DeviceStatus__handle;
}
