...
static const _CoreCommand_type_support_symbol_names_t _CoreCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sensor, msg, CoreCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor, msg, CoreCommand)),
  }
};
...
{
  return &::sensor::msg::rosidl_typesupport_cpp::CoreCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sensor, msg, CoreCommand)() {
  return get_message_type_support_handle<sensor::msg::CoreCommand>();
}
