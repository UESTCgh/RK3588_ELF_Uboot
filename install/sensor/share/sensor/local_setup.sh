...
: ${AMENT_CURRENT_PREFIX:="/home/uboot/data/ros2_uboot/install/sensor"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sensor/environment/pythonpath.sh"
